        ...
        angular.module("angular-carousel").service("DeviceCapabilities", function() {
            ...
            return function(b, c, d) {
                var e, f = {
                    ...
                    i = (616 - Math.abs(g)) / 616;
                if ("zoom" == d) {
                    f[a.transformProperty] = h;
                    var m = 1;
                    Math.abs(g) < 616 && (m = 1 + 2 * (1 - i)), f[a.transformProperty] += " scale(" + m + ")", f["transform-origin"] = "50% 50%", e = 0, Math.abs(g) < 616 && (e = .3 + .7 * i), f.opacity = e
                } 
                ...
                compile: function(l, m) {
                    ...
                    return ["ng-repeat", "data-ng-repeat", "ng:repeat", "x-ng-repeat"].every(function(a) {
                        ...
                        function(l, m, n) {
                            ...
                            function t(a) {
                                var b = 616 * l.carouselBufferIndex + a;
                            ...
                            function u(a, b) {
                                if (void 0 === a && (a = l.carouselIndex), b = b || {}, b.animate === !1 || "none" === H.transitionType) return N = !1, J = -616 * a, l.carouselIndex = a, A(), void 0;
                                N = !0;
                                var c = new j;
                                c.tween({
                                    from: {
                            ...
                            function z(a, b) {
                                if ((!b || K) && (c.unbind("mouseup", q), C = !1, K = !1, E = D - a.x, 0 !== E && !N))
                                    if (J += 616 * -E / L, H.isSequential) {
                                        ...
                                        l.carouselIndex = parseInt(-J / 616, 10), A()
                                    })
                            }
