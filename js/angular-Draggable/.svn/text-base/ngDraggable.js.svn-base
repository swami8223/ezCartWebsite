                  ...
                  //  return;
                    ...
                    var onlongpress = function(evt) {
                        ...
                        //element.centerY = (element.height()/2);
						 element.centerX = element.width();
                        element.centerY = element.height();
                        ...
                        if (_centerAnchor) {
                            ...
                            _tx = offset.left - $window.scrollLeft() - 128;
                            _ty = offset.top - $window.scrollTop() - 116;    
                        }
                    ...
                    var onmove = function(evt) {
                        ...
                        _my = (evt.pageY || evt.originalEvent.touches[0].pageY);
                         ...
                         if (_centerAnchor) {
                            _tx = _mx - element.centerX - $window.scrollLeft() - 128;
                            _ty = _my - element.centerY - $window.scrollTop() - 116;
                        } else {
                            _tx = _mx - _mrx - $window.scrollLeft() - 128;
                            _ty = _my - _mry - $window.scrollTop() - 116;
                        }
